...
import {fetcher, useMounts, useSlicedMounts} from "../../utils/hooks/useMounts";
...
export const getStaticProps: GetStaticProps = async () => {
	const mounts = await fetcher<IMount[]>("https://tychondi.dk/mount/api/mount");
	return {
		props: {
			mounts: mounts
		}
...
const Index: ({mounts}: { mounts: IMount[] }) => JSX.Element = ({mounts}: { mounts: IMount[] }) => {
